...
const SEQUENCE_ENV_ALIASES = {
  ...
  transactional_booking_received_v2: "SEQUENCE_BOOKING_RECEIVED",
  transactional_booking_confirmation: "SEQUENCE_BOOKING_CONFIRMED",
  transactional_booking_confirmation_v2: "SEQUENCE_BOOKING_CONFIRMED",
  transactional_admin_new_appointment: "SEQUENCE_ADMIN_NEW_APPOINTMENT",
  transactional_admin_new_appointment_v2: "SEQUENCE_ADMIN_NEW_APPOINTMENT",
  transactional_employee_assign: "SEQUENCE_EMPLOYEE_ASSIGN",
  transactional_employee_assign_v2: "SEQUENCE_EMPLOYEE_ASSIGN",
  transactional_user_appointment_rescheduled: "SEQUENCE_USER_RESCHEDULE",
  transactional_user_appointment_rescheduled_v2: "SEQUENCE_USER_RESCHEDULE",
  transactional_employee_appointment_rescheduled: "SEQUENCE_EMPLOYEE_RESCHEDULE",
  transactional_employee_appointment_rescheduled_v2: "SEQUENCE_EMPLOYEE_RESCHEDULE",
  service_feedback: "SEQUENCE_SERVICE_FEEDBACK",
  service_feedback_v2: "SEQUENCE_SERVICE_FEEDBACK",
