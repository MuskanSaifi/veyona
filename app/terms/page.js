...
export default function TermsOfServicePage() {
  ...
  const heroTitle = pageContent?.heroTitle || "Terms of Service";
  const heroDescription = pageContent?.heroDescription || "Please read these terms carefully before using our services. By using our website and services, you agree to be bound by these terms.";
